...
## Project Structure
    ...
    ├── testapiautodatamod_112750  # Django project configurations
...
1. Clone this repo and `cd testapiautodatamod_112750`
...
2. Clone this repo and `cd testapiautodatamod_112750`
